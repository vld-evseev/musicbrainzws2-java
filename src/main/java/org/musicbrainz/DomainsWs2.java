...
public abstract class DomainsWs2 {
    ...
    */
    ...
    public static final String MAINHOST = "musicbrainz.eu";
    public static final String ANNOTATIONHOST = "search.musicbrainz.eu";
   	
    public static final String AUTHREALM = "musicbrainz.eu";
